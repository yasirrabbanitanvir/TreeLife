...
const Sidebar = ({ onSectionChange }) => {
  ...
  return (
    <nav
      aria-label="Sidebar"
      className="bg-green-800 shadow-xl w-full md:w-48 fixed md:relative z-10 flex flex-col items-center md:items-start h-screen md:h-auto"
    >
      {/* Logo / Header */}
      <div className="w-full py-4 bg-green-900 flex justify-center md:justify-start px-4 md:pl-6 text-white text-xl font-bold">
