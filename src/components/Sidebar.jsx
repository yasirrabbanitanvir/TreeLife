...
const Sidebar = ({ onSectionChange, isOpen, onToggleSidebar }) => {
  const handleSectionChange = (section) => {
    onSectionChange(section);
  };
  ...
  return (
    <div
      className={`bg-green-800 shadow-xl min-h-screen w-full md:w-48 fixed top-0 left-0 z-10 transition-transform transform ${
        isOpen ? "translate-x-0" : "-translate-x-full"
      } md:relative md:translate-x-0`} // Sidebar transition for mobile
    >
      <div className="w-full md:pt-8 mt-10">
        <ul className="w-full space-y-2">
          <li>
